# app.py (MySQL + SQLAlchemy 修正版 - 全文)
...
# --- SQLAlchemyの設定 (MySQL用) ---
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
# ★ 必ずご自身のMySQL環境に合わせて以下の値を修正してください ★
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
DB_USER = 'Great_Tomato'      # ★MySQLで作成したユーザー名に変更
DB_PASSWORD = 'agab93jg40g3ig' # ★MySQLで作成したパスワードに変更
DB_HOST = 'localhost'             # MySQLサーバーのホスト名 (通常はlocalhost)
DB_PORT = '3306'                  # MySQLサーバーのポート番号 (通常は3306)
DB_NAME = 'typing_game_db'        # ★MySQLで作成したデータベース名に変更
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★

# --- DBドライバの選択 (どちらか一方のコメントアウトを解除) ---

# --- Option 1: mysqlclient を使う場合 ---
# db_uri = f'mysql+mysqlclient://{DB_USER}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_NAME}?charset=utf8mb4'

# --- Option 2: PyMySQL を使う場合 (こちらを有効化する場合) ---
pymysql.install_as_MySQLdb() # PyMySQLを使う場合はこの行が必要
